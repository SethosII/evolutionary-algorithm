...
GNUTERM = "wxt"
plot "500-500.csv" using 1:4 with lines title "500 - 500", '5000-5000.csv' using 1:4 with lines title "5000 - 5000", '500-5000.csv' using 1:4 with lines title "500 - 5000", '5000-500.csv' using 1:4 with lines title "5000 - 500"
#    EOF
